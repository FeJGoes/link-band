    ...
    <div id="form-create" class="uk-width-1-2 ">
        <div class="uk-width-1-2 uk-margin-auto uk-flex uk-flex-column">
            <div class="uk-margin uk-text-center">
                ...
                <h5 class="lb-color-text uk-margin-small">Criando minha conta</h5>
                <p class="lb-color-text uk-margin-small">Let's do it! É bem rápido</p>
            </div>
            ...
            <div class="uk-margin-medium-top uk-flex uk-flex-around">
                <a href="<?=HOST?>" class="lb-color-text uk-button uk-width-1-3">voltar</a>
                <button id="btn-create" class="lb-button lb-button-primary uk-width-1-3">criar</button>
            </div>
        </div>
    </div>
</main>