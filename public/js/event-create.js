...
function createEvent(form, btn, genero, titulo, data, hora, telefone, celular, descricao, cep, logradouro, numero, complemento, bairro, cidade, estado, banner)
{
    if(findEmpty(form) === false)
    {
        url  = location.origin+'/area-restrita/eventos/store'
        dataF = new FormData
